(function($, document, window, undefined) {
  window.IPRedirect = {
    ...
    fetchAndShowRedirect: function( location ) {
      ...
      if ( self.urlMap[location.country_code] && self.urlMap[location.country_code].url != null ) {
        var countryName = (self.countryTranslations[location.country_name]) ? self.countryTranslations[location.country_name] : location.country_name,
            redirectUrl = self.urlMap[location.country_code].url;
        ...
        self.RedirectMe.attr("href", redirectUrl);
    ...
    fetchAndRedirectOnResponse: function( location ) {
      ...
      if(self.urlMap[location.country_code] && self.urlMap[location.country_code].url != null) {
        var redirectUrl = self.urlMap[location.country_code].url;
