...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"core/owl.carousel.min.js":[function(require,module,exports) {
...
theme.Search = function () {
  ...
  function searchFocus($el) {
    $el.focus(); // set selection range hack for iOS
...
theme.Video = function () {
  ...
  function autoplayCheckFunction(player, $videoWrapper) {
    ...
    player.playVideo();
    autoplayTest(player).then(function () {
  ...
  function onPlayerReady(evt) {
    ...
    sizeBackgroundVideos(); // Customize based on options from the video ID
...
theme.Cart = function () {
  ...
  Cart.prototype = _.assignIn({}, Cart.prototype, {
    ...
    _onEditClick: function _onEditClick(evt) {
...
theme.Filters = function () {
  ...
  Filters.prototype = _.assignIn({}, Filters.prototype, {
    ...
    _onFilterChange: function _onFilterChange() {
      var filter = this._getFilterValue(); // remove the 'page' parameter to go to the first page of results


      var search = document.location.search.replace(/\?(page=\w+)?&?/, ''); // only add the search parameters to the url if they exist
    ...
    _sortValue: function _sortValue() {
    ...
    _resizeSelect: function _resizeSelect($selection) {
...
theme.Product = function () {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initImageSwitch: function _initImageSwitch() {
    ...
    _setActiveThumbnail: function _setActiveThumbnail(imageId) {
      // If there is no element passed, find it by the current product image
      if (typeof imageId === 'undefined') {
        imageId = $(this.selectors.productImageWraps + ':not(.hide)', this.$container).data('image-id');
      }
    ...
    _switchImage: function _switchImage(imageId) {
    ...
    _handleImageFocus: function _handleImageFocus(evt) {
    ...
    _updateImages: function _updateImages(evt) {
      var variant = evt.variant;
    ...
    _updatePrice: function _updatePrice(evt) {
      ...
      var $salePrice = $(this.selectors.salePrice, $priceContainer); // Reset product price state

      $priceContainer.removeClass(this.classes.productUnavailable).removeClass(this.classes.productOnSale).removeAttr('aria-hidden'); // Unavailable
...
},{"./bundle-url":"../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../styles/theme.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"theme.js":[function(require,module,exports) {
"use strict";

require("babel-polyfill");

require("./core/owl.carousel.min.js");

require("./core/theme.js");

require("../styles/theme.scss");

console.log('hey Parcel.js!');
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./core/owl.carousel.min.js":"core/owl.carousel.min.js","./core/theme.js":"core/theme.js","../styles/theme.scss":"../styles/theme.scss"}],"../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","theme.js"], null)
